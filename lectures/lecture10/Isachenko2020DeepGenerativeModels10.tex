...
\begin{frame}{StyleGAN}
	\begin{block}{Step 3: Remove traditional input}
		\begin{figure}
			\centering
			\includegraphics[width=0.4\linewidth]{figs/stylegan_input}
		\end{figure}
	\vspace{-0.4cm}
	\end{block}
	\begin{block}{Step 4: Style Mixing}
		\begin{itemize}
		\item Generate two vectors $\bw_1$ and $\bw_2$ for vectors $\bz_1$ and $\bz_2$.
		\item Switch from one latent code to another at a randomly selected point	in the synthesis network.
		\item It makes different levels of synthesis network to be independent.
		\end{itemize}
	\end{block}
	\vfill
	\hrule\medskip 
...
%=======
\begin{frame}{StyleGAN}
	\begin{block}{Step 5: Stochastic variation}
...
\begin{frame}{StyleGAN}
	\begin{figure}
		\centering
		\includegraphics[width=0.6\linewidth]{figs/stylegan_scheme}
	\end{figure}
	\begin{figure}
		\centering
		\includegraphics[width=0.5\linewidth]{figs/stylegan_results}
	\end{figure}
	\vfill
	\hrule\medskip 
	{\scriptsize \href{https://arxiv.org/abs/1812.04948}{https://arxiv.org/abs/1812.04948}}
...
\begin{frame}{StyleGAN}
	\begin{block}{Samples (1024x1024)}
		\begin{figure}
			\centering
			\includegraphics[width=\linewidth]{figs/stylegan_samples}
		\end{figure}
	\vspace{0.5cm}
	\end{block}
	\vfill
